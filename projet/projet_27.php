    ...
    <div class="projects-container">
        <div class="project-card">
            <div class="project-image">
               <p><img src="uploads/lac-leman-suisse.jpg" alt="Image du projet"></p>
            </div>
    <div class="project-details">
        <h1>Titre : fejhsqj </h1>
        <div>
        <p><strong>Année de BUT:</strong> exprimer</p>
        <p><strong>Compétence :</strong> </p>
        <p class="description"> ftftyf</p>
        <p><strong>Date:</strong> 6655-09-08</p>
        </div>
    </div>
</section>
<section>
